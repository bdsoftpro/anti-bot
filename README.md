...
> Any `.org`, `.com`, or custom domain claiming to be Anti-Bot is an **unauthorized mirror** and should be treated as a malicious honeypot designed to steal your fingerprint data.
>
> * ✅ **Official:** `https://bdsoftpro.github.io/anti-bot`
> * ❌ **Unsafe:** All other URLs.

[https://bdsoftpro.github.io/anti-bot](https://bdsoftpro.github.io/anti-bot)
